...
<script type="text/javascript">
	...
	$("#confirmPwd").blur(function(){
		if(checkEquals()){
			$("#confirmPwdSpan").html("确认密码相同");
			$("#confirmPwdSpan").css("color","green");
		}else{
			$("#confirmPwdSpan").html("确认密码不相同");
	...
	function changePassword(){
		...
		if(checkPasswordLength(oldPwdVal)&&checkPasswordLength(newPwdVal)&&checkEquals()){
			$.ajax({
